	...
	<div class="tab-pane fade in" id="mobile">
		<div class="container leftband">
			<div class="row-fluid">
				<div class="span">
					<ul id="mobileList">
						<li><ahref="#reg">- How to registar from your mobile phone?</a></li>
						<li><a href="#down">- How to Download Envirocar application?</a></li>
						<li><ahref="#sync">- How to Synchronize your data?</a></li>
					</ul>
				</div> 
			</div>
		</div>
	...
	<div class="tab-pane fade in" id="website">
		<div class="container leftband>
			<div class="row-fluid">
				<div class="span">
					<ul id="websiteList">
						<li><ahref="#sign">- How to Register, Sign In and log out ?</a></li>
						<li><a href="#compare">- How to Comapre your Data?</a></li>
						<li><ahref="#share">- How to Share your Data?</a></li>
						<li><ahref="#Cookies">- Why does this website use cookies?</a></li>
						<li><ahref="#lang">- Which are the supported languages?</a></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="tab-pane fade in" id="faqs">
		<div class="container leftband">
			<div class="row-fluid">
				<div class="span">
					<ul id="faqList">
						<li><ahref="#q1"> Q1: How does it work?</a></li>		
						<li><ahref="#q2"> Q2: How to get started? What are the requirements?</a></li>
						<li><ahref="#q3"> Q3: Which OBD-II adapters are compatible with enviroCar?</a></li>		
						<li><ahref="#q4"> Q4: Is my car supported?</a></li>
						<li><ahref="#q5"> Q5: Why do we need Indiegogo backers?</a></li>		
						<li><ahref="#q6"> Q6: What’s about privacy and security?</a></li>
						<li><ahref="#q7"> Q7: I’m a developer and very interested in this project. Is there a way to make some further implementations?</a></li>
						<li><ahref="#q8"> Q8: What’s next?</a></li>		
						<li><ahref="#q9"> Q9: When enviroCar will be published?</a></li>	
						<li><ahref="#q10"> Q10: Can we ship to your country?</a></li>	
					</ul>
				</div>
			</div> 
		</div>
