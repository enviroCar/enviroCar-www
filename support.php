...
<div class="container rightband" style="padding-left:20px; padding-top:20px">
 <div class="row-fluid">
 		<div class="span9 offset1">
		<div class="customLi"><h3><span id="what"></span>What is EnviroCar?</h3>
...
<div class="container leftband" style="padding-right:20px; padding-top:20px; padding-top:20px">
 <div class="row-fluid">
 		<div class="span9 offset1">
		<div class="customLi"><h3><span id="how"></span>How EnviroCar works?</h3>
   ...
   <!--end of div id="main"-->
	...
	<div class="row-fluid">
		...
		<div class="container rightband" style="padding-left:20px; padding-top:20px">
			<div class="row-fluid">
				<div class="span9 offset1">
				<div class="customLi"><h3><span id="reg"></span>Registration</h3>
					<p>  
		...
		<div class="container leftband" style="padding-right:20px; padding-top:20px; padding-top:20px">
			<div class="row-fluid">
				<div class="span9 offset1">
				<div class="customLi"><h3><span id="down"></span>Downloading</h3>
					<p>  
		...
		<div class="container rightband" style="padding-left:20px; padding-top:20px">
			<div class="row-fluid">
				<div class="span9 offset1">
				<div class="customLi"><h3><span id="sync"></span>synchronization</h3>
					<p>  
