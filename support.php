		...
		<div class="tab-content">
			<div class="tab-pane fade in active" id="main">
					...
					<div class="row-fluid">
						<div class="span9 offset1 ">
							<ul id="recentActivities" style="margin-bottom: 10px; overflow-y:auto">
								<li><a style="font-size:14px" href="#what">- What is EnviroCar?</a></li>
								<li><a style="font-size:14px"  href="#how">- How EnviroCar works?</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="container rightband" style="padding-left:20px; padding-top:20px">
					<div class="row-fluid">
						<div class="span9 offset1">
							<h3><span id="what"></span>What is EnviroCar?</h3>
				...
				<div class="container leftband" style="padding-right:20px; padding-top:20px; padding-top:20px">
					<div class="row-fluid">
						<div class="span9 offset1">
							<h3><span id="how"></span>How EnviroCar works?</h3>
							<p style="text-align: justify; font-size:15px; margin-bottom: 10px; overflow-y:auto">
								...
								<br/>
								<br/>
								<img class="offset2" src="./assets/img/obd_adapter.png" height="200" width="400" >
								<br/>
								<br/>
			...
			<div class="tab-pane fade in " id="mobile">
				<div class="container leftband" style="padding-right:20px; padding-top:20px; padding-top:20px">
					<div class="row-fluid">
						<div class="span9 offset1 ">
							<ul id="recentActivities" style="margin-bottom: 10px; overflow-y:auto">
								<li><a style="font-size:14px" href="#reg">- How to registar from your mobile phone?</a></li>
								<li><a style="font-size:14px"  href="#down">- How to Download Envirocar application?</a></li>
								<li><a style="font-size:14px" href="#sync">- How to Synchronize your data?</a></li>
							</ul>
						</div> 
					</div>
				</div>
				<div class="container rightband" style="padding-left:20px; padding-top:20px">
					<div class="row-fluid">
						<div class="span9 offset1">
							<h3><span id="reg"></span>Registration</h3>
							<p>  
				...
				<div class="container leftband" style="padding-right:20px; padding-top:20px; padding-top:20px">
					<div class="row-fluid">
						<div class="span9 offset1">
						<h3><span id="down"></span>Downloading</h3>
						<p>  
			...
			<div class="container rightband" style="padding-left:20px; padding-top:20px">
				<div class="row-fluid">
					<div class="span9 offset1">
						<h3><span id="sync"></span>synchronization</h3>
						<p>  
		...
		<div class="tab-pane fade in " id="website">
			<div class="container leftband" style="padding-right:20px; padding-top:20px; padding-top:20px">
				<div class="row-fluid">
					<div class="span9 offset1 ">
						<ul id="recentActivities" style="margin-bottom: 10px; overflow-y:auto">
							<li><a style="font-size:14px" href="#sign">- How to Register, Sign In and log out ?</a></li>
							<li><a style="font-size:14px"  href="#compare">- How to Comapre your Data?</a></li>
							<li><a style="font-size:14px" href="#share">- How to Share your Data?</a></li>
							<li><a style="font-size:14px" href="#Cookies">- Why does this website use cookies?</a></li>
							<li><a style="font-size:14px" href="#lang">- Which are the supported languages?</a></li>
						</ul>
					</div>
				</div>
			</div>
	  		<div class="container rightband" style="padding-left:20px; padding-top:20px">
				<div class="row-fluid">
					<div class="span9 offset1">
						<h3><span id="sign"></span>How to Register and Sign In ?</h3>
						<strong style="font-size:14px;"> Register </strong> 
						<p style="text-align: justify; font-size:14px;">
							<img class="offset2" src="./assets/img/registrationsteps.jpg" height="450" width="650" />
							<br/>
						...
						<p style="text-align: justify; font-size:14px;">
							<img class="offset2" src="./assets/img/sign.jpg" height="450" width="600" />
							<br/>
							1-From the start page; fill your user name and password and press “SignIn”.
							<br/>
						</p>
						<strong style="font-size:14px;"> Logging Out </strong>
						<p style="text-align: justify; font-size:14px;">
							<img class="offset2" src="./assets/img/logout.jpg" height="200" width="350" />
							<br/>
			...
			<div class="container leftband" style="padding-right:20px; padding-top:20px; padding-top:20px">
				<div class="row-fluid">
					<div class="span9 offset1">
						<h3><span id="compare"></span>How to Compare your Data?</h3>
						<p>  
			...
			<div class="container rightband" style="padding-left:20px; padding-top:20px">
				<div class="row-fluid">
					<div class="span9 offset1">
						<h3><span id="share"></span>How to share your data?</h3>
						<p>  
			...
			<div class="container leftband" style="padding-right:20px; padding-top:20px; padding-top:20px">
				<div class="row-fluid">
					<div class="span9 offset1">
						<h3><span id="Cookies"></span>Why does this website use cookies?</h3>
						<p style="text-align: justify; font-size:14px;">  
			...
			<div class="container rightband" style="padding-left:20px; padding-top:20px">
				<div class="row-fluid">
					<div class="span9 offset1">
						<h3><span id="lang"></span>Which are the supported languages?</h3>
						<p style="text-align: justify; font-size:14px;">  
