...
<div class="container rightband" style="padding-left:20px; padding-top:20px">
 <div class="row-fluid">
 		<div class="span9 offset1">
		<div class="customLi"><h3><span id="what">What is EnviroCar?</span></h3>
...
<div class="container leftband" style="padding-right:20px; padding-top:20px; padding-top:20px">
 <div class="row-fluid">
 		<div class="span9 offset1">
		<div class="customLi"><h3><span id="how">How EnviroCar works?</span></h3>
   ...
   <!--end of div id="main"-->
	...
	<div class="row-fluid">
		...
		<div class="container rightband" style="padding-left:20px; padding-top:20px">
			<div class="row-fluid">
				<div class="span9 offset1">
				<div class="customLi"><h3><span id="reg">Registration</span></h3>
					<p>  
		...
		<div class="container leftband" style="padding-right:20px; padding-top:20px; padding-top:20px">
			<div class="row-fluid">
				<div class="span9 offset1">
				<div class="customLi"><h3><span id="down">Downloading</span></h3>
					<p>  
		...
		<div class="container rightband" style="padding-left:20px; padding-top:20px">
			<div class="row-fluid">
				<div class="span9 offset1">
				<div class="customLi"><h3><span id="sync">synchronization</span></h3>
					<p>  
	...
	<div class="row-fluid">
        <div class="span9 offset1 ">
			...
			<div class="row-fluid">
				<div class="span9 offset1">
				<div class="customLi">
					<h3><span id="sign">How to Register and Sign In ?</span></h3>
		...
		<div class="container leftband" style="padding-right:20px; padding-top:20px; padding-top:20px">
			<div class="row-fluid">
				<div class="span9 offset1">
				<div class="customLi">
				<h3><span id="compare">How to Compare your Data?</span></h3>
					<p>  
		...
		<div class="container rightband" style="padding-left:20px; padding-top:20px">
			<div class="row-fluid">
				<div class="span9 offset1">
				<div class="customLi">
				<h3><span id="share">How to share your data?</span></h3>
					<p>  
	  ...
	  <div class="container leftband" style="padding-right:20px; padding-top:20px; padding-top:20px">
			<div class="row-fluid">
				<div class="span9 offset1">
				<div class="customLi">
				<h3><span id="Cookies">Why does this website use cookies?</span></h3>
					<p style="text-align: justify; font-size:14px;">  
		 ...
		 <div class="container rightband" style="padding-left:20px; padding-top:20px">
			<div class="row-fluid">
				<div class="span9 offset1">
				<div class="customLi">
				<h3><span id="lang">Which are the supported languages?</span></h3>
					<p style="text-align: justify; font-size:14px;">  
