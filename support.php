		...
		<div class="tab-content">
			<div class="tab-pane fade in active" id="main">
				...
				<div class="container leftband">
					<div class="row-fluid">
						<div class="span" style="padding-right: 1ex">
							<h2><span class="anchor" id="what"></span>What is EnviroCar?</h2>
				...
				<div class="container leftband">
					<div class="row-fluid">
						<div class="span" style="padding-right: 1ex">
							<h2><span class="anchor" id="how"></span>How EnviroCar works?</h2>
							<p style="text-align: justify;">
			...
			<div class="tab-pane fade in" id="mobile">
				...
				<div class="container leftband">
					<div class="row-fluid">
						<div class="span" style="padding-right: 1ex">
							<h2><span class="anchor" id="reg"></span>Registration</h2>
							<p style="text-align: justify;">  
				...
				<div class="container leftband">
					<div class="row-fluid">
						<div class="span" style="padding-right: 1ex">
							<h2><span class="anchor" id="down"></span>Downloading</h2>
							<p style="text-align: justify;">  
				...
				<div class="container leftband">
					<div class="row-fluid">
						<div class="span" style="padding-right: 1ex">
							<h2><span class="anchor"  id="sync"></span>synchronization</h2>
							<p style="text-align: justify;">  
			...
			<div class="tab-pane fade in" id="website">
				...
				<div class="container leftband">
					<div class="row-fluid">
						<div class="span" style="padding-right: 1ex">
							<h2><span class="anchor" id="sign"></span>How to Register and Sign In ?</h2>
				...
				<div class="container leftband">
					<div class="row-fluid">
						<div class="span" style="padding-right: 1ex">
							<h2><span class="anchor" id="compare"></span>How to Compare your Data?</h2>
							<p style="text-align: justify;">  
				...
				<div class="container leftband">
					<div class="row-fluid">
						<div class="span" style="padding-right: 1ex">
							<h2><span class="anchor" id="share"></span>How to share your data?</h2>
							<p style="text-align: justify;">  
				...
				<div class="container leftband">
					<div class="row-fluid">
						<div class="span" style="padding-right: 1ex">
							<h2><span class="anchor" id="Cookies"></span>Why does this website use cookies?</h2>
							<p style="text-align: justify;">  
				...
				<div class="container leftband">
					<div class="row-fluid">
						<div class="span" style="padding-right: 1ex">
							<h2><span class="anchor" id="lang"></span>Which are the supported languages?</h2>
							<p style="text-align: justify;">
