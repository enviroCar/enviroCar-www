  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top customNav">
      <div class="customNav">
  	  ...
  	  <img src="./assets/img/Logo_icon.svg" class="brand" style="height: 55px; padding:0; margin:0; padding-right:15px; ">
          <a class="brand" href="main_index.php">enviroCar</a>
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li <?=echoActiveClassIfRequestMatches("help")?>><a href="support_new.php">Help</a></li>
            </ul>
			   <div class="pull-right" style="height: 50px; padding:0; margin:0;" >
				<a style="color:#AAAAAA; font-size: 14px">  new user ?</a></br>
            <input style="font-size: 12px" type="text" id="input user name" placeholder="User Name">
            <input style="font-size: 12px" type="password" id="inputPassword" placeholder="Password">
