...
*
*
* Search for #customevent for my modifications
*/
...
(function () {
    ...
    DataSeries.prototype.findDataPointByX = function (x, findClosest) {
        ...
        searchResult = { dataPoint: null, distance: Infinity, index: NaN };
        var steps = 0;
        var dataPoint = null;
        ...
        //custom mouse event here! #customevent #Martin
        if(oldSearchResult == null || searchResult.dataPoint.x != oldSearchResult.dataPoint.x){
          selectPoint(dataHash[searchResult.dataPoint.x])
        }
        //end custom mouse event
