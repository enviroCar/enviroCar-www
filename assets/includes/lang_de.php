...
$index_lost_password_access_denied="Zugriff verweigert! Da du eingeloggt bist, kannst du versuchen dein Passwort über 'Profil bearbeiten' ändern.";
...
$index_captcha_instructions_visual="Geben Sie die Wörter ein";
$index_captcha_instructions_audio="Geben Sie ein, was Sie hören";
$index_captcha_play_again="CAPTCHA erneut abspielen";
$index_captcha_cant_hear_this="<br>Als mp3 herunterladen<br>";
$index_captcha_visual_challenge="Ein Bild-CAPTCHA anzeigen<br>";
$index_captcha_audio_challenge="Ein Audio-CAPTCHA abspielen<br>";
$index_captcha_refresh_btn="Ein anderes CAPTCHA anzeigen";
$index_captcha_help_btn="Hilfe";
$index_captcha_incorrect_try_again="Unzutreffend. Erneut versuchen?";
...
$privacy_website_text_register_datalist = "<li>Der gewählte Benutzername</li><li>Die angegebene E-Mail-Adresse</li><li>Das angegebene Passwort</li><li>Der Benutzername der Personen, die deinen Benutzernamen als Freund hinzugefügt haben</li><li>Der Benutzername der Personen, die du als Freund hinzugefügt hast</li><li>Der Name der Gruppen, deren Mitglied du geworden bist</li><li>Dein Vorname</li><li>Dein Nachname</li><li>Das Land und der Ort in dem du lebst</li><li>Deine Webseite</li><li>Dein Geschlecht</li><li>Die bevorzugte Sprache dieser Webseite</li><li>Andere Informationen, die du in einem Freitextfeld angegeben hast</li>";
...
$speed_titel = "Aggregierte Tracks";
$speed_description = 'Die Karte gibt einen Überblick über alle Tracks, die bislang über die enviroCar-Plattform erfasst wurden. Die Darstellung zeigt aggregierte gemessenen Geschwindigkeiten. Neue Tracks werden innerhalb weniger Sekunden nach dem Hochladen aus der enviroCar App in die Karte eingebunden. Diese Karte können Sie auch über die ArcGIS App auf ihrem tablet-PC oder Ihrem Smartphone ansehen, wenn Sie nach enviroCar suchen.<br /><br/><a href="http://52north.maps.arcgis.com/apps/webappviewer/index.html?id=602699b2f09340f6bd4086cacf2916d4" title="Live Track Karte">Karte öffnen</a>';
...
<p>In seiner englischsprachigen Online Publikation <a href="http://rpubs.com/edzer/enviroCar" target="_blank">“Analyzing enviroCar trajectories with R”</a> beschreibt Edzer Pebesma anhand einiger Beispiele, wie enviroCar-Daten mit Hilfe von R verarbeitet werden können. Download die begleitende <a href="http://cran.r-project.org/web/packages/trajectories/vignettes/tracks.pdf" title="Analysing Trajectory Data in R">Vignette</a>. Edzer Pebesma ist Professor und leitender Direktor des <a href="http://ifgi.uni-muenster.de" target="_blank">Institutes für Geoinformatik der Universität Münster</a>.<br /><br/><a href="http://rpubs.com/edzer/enviroCar" title="RPubs Skript für Analyse von enviroCar Tracks mit R">Skript öffnen</a></p>';
...
$asACitizenText = 'Alles was du benötigst ist ein Smartphone mit Android Betriebssystem (ab Version 2.3), ein Bluetooth OBD-II-Adapter und ein Fahrzeug, das den OBD-II Standard unterstützt. Steck den Adapter auf den OBD-II Anschluss deines Fahrzeuges und verbinde das System nach den Anweisungen der Bedienungsanleitung des Adapters mit deinem Smartphone.
<br/><br/> 
Die enviroCar App ist im Rahmen des aktuellen Beta-Tests für die Android-Versionen 2.3 - 4.4 verfügbar und steht über <a href="https://play.google.com/store/apps/details?id=org.envirocar.app" target="_blank">Google Play</a> zur Verfügung. Mit der App kannst du dich bei enviroCar als Nutzer registrieren und verschiedene Einstellungen vornehmen (Typ des Fahrzeuges, Bluetooth-Adapter etc. ) und anschließend deine ersten Tracks aufnehmen.
<br/><br/> 
Du kannst deine Daten aus der App zum enviroCar-Server hochladen und die enviroCar Webseite verwenden, um deine Fahrten zu analysieren und in einer Karte zu betrachten. Außerdem kannst du dich hier mit Freunden und Gruppen vernetzen.
<br/><br/> 
Nutz die mit enviroCar gesammelten Daten, um mit Freunden, Wissenschaftlern und den Experten der öffentlichen Verwaltung fundiert über die Umweltaspekte des Autofahrens zu diskutieren. Entwickel eigene Ideen, wie wir unsere Mobiltität sichern und nachhaltig gestalten können.
<br/><br/> 
Derzeit befindet sich enviroCar noch in einer geschlossenen beta-Phase, in der die Software  ergänzt, getestet und für die breitere Anwendung vorbereitet  wird. Sofern Sie als Entwickler  interessiert sind, an den Tests teilzunehmen, wenden Sie sich bitte direkt an das <a href="mailto:enviroCar@52north.org">enviroCar Team bei 52°North</a>.
';
$asAScientistHead = "Als Wissenschaftler";
$asAScientistText = 'Interessierst du dich für die enviroCar-Plattform und die dort vorhandenen Daten als Basis für deine Forschungsvorhaben? Du kannst enviroCar unmittelbar für deine Zwecke anwenden. Nutz die <a href="./dataaccess.php">enviroCar Webschnittstelle</a>, um die Daten in deine Anwendungen zu importieren und dort weiter zu verarbeiten.
<br/><br/>
...
<br/><br/>
Nutz die enviroCar Plattform als Basis für Citizen Science Projekte mit Wissenschaftlern, Fachleuten und den Bürgern in deiner Region. Gern unterstützen wir dich mit unseren Partnern bei der Vorbereitung und Durchführung solcher Projekte. 
<br/><br/>
...
<br/><br/>
Natürlich bist du herzlich eingeladen, der enviroCar-Entwicklergemeinde beizutreten. Nutz das englischsprachige <a href="http://envirocar-discuss.forum.52north.org/" target="_blank">Forum</a> der enviroCar Community, um aktuelle Informationen über den Entwicklungsprozess und neue Funktionalitäten zu erhalten.
';
$about_faqHead = "Häufig gestellte Fragen";
$faq_q1 = "Wo bekomme ich einen OBD-II Adapter?";
$faq_q2 = "Wird mein Auto unterstützt?";
$faq_q3 = "Wie wird der Datenschutz berücksichtigt?";
$faq_q4 = "Wie kann ich als Entwickler zu enviroCar beitragen?";
$faq_q5 = "Was ist der Entwicklungsstatus von enviroCar?";

$faq_a1 = 'Es gibt viele ODB-II-Adapter im Handel. Der Preis liegt zwischen 15 Euro für China-Importe bei eBay und Amazon und ca. 90-200 Euro für sehr hochwertige Systeme aus dem Fachhandel.
<br/><br/>
Zu beachten ist, dass in Europa bestimmte Zertifikate für den Handel von Systemen (EC) und für den Betrieb im fahrenden Fahrzeug (ECE) gesetzlich vorgeschrieben sind. Derzeit scheint unter den handelsüblichen Systemen lediglich der DriveDeck Sport Adapter (W4) mit  allen erforderlichen Zertifikaten ausgestattet zu sein.
<br/><br/>
