...
$synchronization_steps="Sie haben zwei Möglichkeiten die von Ihnen erzeugten Daten hochzuladen.<br><ol><li>Automatischer Upload Ihrer Daten:<br>Sie können dazu entweder eine WLAN Verbindung oder Ihre mobile Internetverbindung nutzen. Die Entsprechenden Einstellungen finden Sie in der enviroCar App unter dem Menüpunkt “Einstellungen”.</li><li>Manueller Upload Ihrer Daten:<br>Alternativ zum automatischen Datenupload in Echtzeit, können Sie Ihre generierten Daten auch manuell auf die enviroCar Plattform hochladen. Navigieren Sie dazu im Menü zu “Meine Fahrten”, wo Sie am oberen rechten Bildschirmrand die Upload-Schalfläche finden. Nach Betätigen der Schaltfläche erhalten Sie eine Rückmeldung über den erfolgreichen Upload Ihrer Daten in der Benachrichtigungsleiste Ihres Smartphones.</li></ol><br><ul><li>Auswahl Ihres Fahrzeuges und Anlegen eines neuen Fahrzeuges:<br>Das “Dashboard” (Hauptmenu) der enviroCar App erlaubt es Ihnen auf unkomplizierte Weise zwischen verschiedenen Fahrzeugen zu wechseln oder neue Fahrzeuge anzulegen. Betätigen Sie dazu die “Bearbeiten” Schaltfläche, wodurch sich die Ansicht zur “Garagenansicht” ändert.<br><br>Scrollen Sie durch diese Liste, um zu prüfen, ob Ihr Fahrzeugtyp bereits existiert<br><br>Ist dem nicht so, können Sie problemlos einen neuen Fahrzeugtyp hinzufügen. Füllen Sie dazu die angebotenen Eingabefelder aus und beenden Sie die Eingabe mit der “Fahrzeug registrieren” Schaltfläche. Der neue Fahrzeugtyp wird daraufhin in die “Garage” aufgenommen.</li><li>Verbinden des Smartphones mit dem OBD-II Adapter:<br>Um die Bluetooth-Verbindung zwischen Ihrem Smartphone und dem OBD-II Adapter herzustellen, wechseln Sie zu den Bluetooth-Verbindungseinstellungen Ihres Gerätes. Aktivieren Sie Bluetooth und starten Sie die Suche nach neuen Geräten. Nach wenigen Sekunden sollte der OBD-II Adapter gefunden werden. Wählen Sie den Adapter und stellen Sie die Verbindung durch Eingabe des korrekten Passwortschlüssels her. Sie sollten in etwa die folgende Anzeige erhalten</li><li>Die Verbindung sollte nun erfolgreich hergestellt sein. Starten Sie im Anschluss die enviroCar App. Wechseln Sie in den Menüpunkt “Einstellungen” und wählen Sie dort den zuvor verbundenen OBD-II Adapter aus. Die Einstellung müssen Sie nur einmal vornehmen und ist ab jetzt gespeichert. Sollten Sie einen anderen Adapter nutzen, wiederholen Sie die oben genannten Schritte</li><li>Aufzeichnung eines neuen Tracks:<br>Öffnen Sie das Hauptmenü der enviroCar App und wählen den Menüpunkt “Start”.<br>Die enviroCar App ist aktiv und Ihre Fahrzeugdaten werden aufgezeichnet.</li></ul>";
