...
$speed_titel = "Aggregated Tracks";
$speed_description = 'This map provides an overview of all enviroCar tracks. It displays the aggregated measured speed. New tracks are integrated within seconds after uploading them from the enviroCar app. You can access this map from the ArcGIS app on your tablet pc or your smartphone. Just search for enviroCar.<br /><br/>Open the <a href="http://52north.maps.arcgis.com/apps/webappviewer/index.html?id=602699b2f09340f6bd4086cacf2916d4" title="Live track overview map">map</a>.';
...
<p>In his online publication “Analyzing enviroCar trajectories with R”, Edzer Pebesma uses several examples to describe how to use R for analyzing enviroCar data. Read the accompanying <a href="http://cran.r-project.org/web/packages/trajectories/vignettes/tracks.pdf" title="Analysing Trajectory Data in R">vignette</a>. Edzer Pebesma is professor and managing director of the <a href="http://ifgi.uni-muenster.de" target="_blank">Institute for Geoinformatics at Münster University</a>.<br /><br/> Open the <a href="http://rpubs.com/edzer/enviroCar" title="RPubs script for analyzing enviroCar trajectory data with R">script</a>.</p>';
