...
?>
    ...
    <script type="text/javascript">
      ...
      function login(ln, lp){
        if(ln === ''){
          alert("<? echo $index_invalid_login_name;?>");
        }
        else if(lp === ''){
          alert('<? echo $index_empty_password;?>');
        }else{
	    ...
	    if ($login_form_attempt>=1){
	      ...
	      if ($login_name != "" &&  $login_password == ""){
			...
			<div class="container alert alert-block alert-error fade in">
				...
				<h4 class="alert-heading"><? echo $index_access_denied;?></h4>
				<? echo $index_empty_password;?>
			</div>
			<?
	      }
	      ...
	      if ($login_name == "" && $login_password == ""){
			...
			<div class="container alert alert-block alert-error fade in">
				<a class="close" data-dismiss="alert">×</a>  
				<h4 class="alert-heading"><? echo $index_access_denied;?></h4>
				<? echo $index_credentials_invalid;?>
			</div>
			<?
	      }
...
=======
		...
		<h2 class="featurette-heading"><? echo $index_how_it_works;?><span class="muted"><? echo ' '.$index_this_is_community;?></span></h2>
>>>>>>> Additional Translations(dashboard,functions,registration), index changed variable names, adding flag symbols from free license source,
		<p class="lead" style="text-align: justify">
		</p>
      </div>
